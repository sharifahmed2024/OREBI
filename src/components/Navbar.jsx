 ...
 return (
   <nav className='bg-slate-300 md:bg-white'>
    <Container className="md:py-8 p-4 px-3 md:px-0 flex md:justify-center justify-end gap-5 md:gap-0 items-center relative">
          <Image className="absolute left-3 md:left-0 top-1/2 -translate-y-1/2" href='/' src={logo} alt='' />
          
        

                <ul className={`transition-all duration-500 flex gap-x-10  bg-slate-200 md:bg-transparent items-center z-10  flex-col md:flex-row md:static absolute left-0 top-full w-full md:w-auto ${show? "translate-x-0  visible opacity-100 " : "-translate-x-full invisible opacity-0 "}`}>
